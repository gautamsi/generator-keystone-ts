...
// Require keystone
import * as keystone from 'keystone';<% if (viewEngine == 'hbs') { %>
import * as handlebars from 'express-handlebars';<% } else if (viewEngine == 'nunjucks') { %>
import * as cons from 'consolidate';
import * as nunjucks from 'nunjucks';<% } else if (viewEngine == 'twig') { %>
